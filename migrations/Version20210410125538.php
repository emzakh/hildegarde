 ...
 */
final class Version20210410125538 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commentaires (id INT AUTO_INCREMENT NOT NULL, recette_id INT DEFAULT NULL, author_id INT DEFAULT NULL, contenu LONGTEXT NOT NULL, rating INT DEFAULT NULL, INDEX IDX_D9BEC0C489312FE9 (recette_id), INDEX IDX_D9BEC0C4F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, categorie VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, nomlatin VARCHAR(255) DEFAULT NULL, effets VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recettes (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, date DATE DEFAULT NULL, description LONGTEXT DEFAULT NULL, etapes LONGTEXT NOT NULL, INDEX IDX_EB48E72CF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_recettes (type_id INT NOT NULL, recettes_id INT NOT NULL, INDEX IDX_26B7C0D0C54C8C93 (type_id), INDEX IDX_26B7C0D03E2ED6D6 (recettes_id), PRIMARY KEY(type_id, recettes_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_recettes DROP FOREIGN KEY FK_26B7C0D03E2ED6D6');

 ...
 */
final class Version20210416131124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recettes (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, date DATE DEFAULT NULL, description LONGTEXT DEFAULT NULL, etapes LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_EB48E72CF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
